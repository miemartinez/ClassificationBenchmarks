...
*This code was developed for use in class and has been slightly adapted for this project.
"""
...
class NeuralNetwork:
    ...
    def __repr__(self):
        ...
        return "\nNeuralNetwork: {}".format("-".join(str(l) for l in self.layers))
    ...
    def fit(self, X, y, epochs=1000, displayUpdate=50):
        ...
        for epoch in np.arange(0, epochs):
            ...
            if epoch == 0 or (epoch + 1) % displayUpdate == 0:
                ...
                print("\n[INFO] epoch={}, loss={:.7f}".format(epoch + 1, loss))
